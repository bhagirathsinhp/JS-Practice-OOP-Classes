...
class App {
  static init() {
    ...
    activePrjList.setSwitchHandlerFunction(
      finishedPrjList.addProject.bind(finishedPrjList)
    );
    finishedPrjList.setSwitchHandlerFunction(
      activePrjList.addProject.bind(activePrjList)
    );
  }
}
